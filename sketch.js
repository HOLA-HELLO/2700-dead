...
function setup() {
  ...
  submarino.scale = 0.3;
  submarino.setCollider("rectangle",0,-50,450,350);
  ...
  invW = createSprite(1025,160,650,5);
  invW.visible = false;
  
  invS = createSprite(1025,399,650,5);
  invS.visible = false;
...
function draw() {
  ...
  text.depth = +1;
    ...
    if(keyDown("W")){
      ...
      submarino.y = submarino.y -10;
      
    }

    if(keyDown("A")){
      
      submarino.x = submarino.x -10;
